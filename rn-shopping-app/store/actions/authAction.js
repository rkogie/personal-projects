...
export const signUp = (email, password) => {
    return async dispatch => {
        const response = await fetch(
            'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA6TS5S9BHStD5lXPDDdx0bQUaXgkchK6U',
            {
                method: 'POST',
                headers: {
...
export const logIn = (email, password) => {
    return async dispatch => {
        const response = await fetch(
            'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA6TS5S9BHStD5lXPDDdx0bQUaXgkchK6U',
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
